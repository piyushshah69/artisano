    ...
    <footer className="border-t border-gray-200 py-6">
      <div className="container mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 px-4 lg:px-0 mt-2">
        <div className="col-span-2">
          <h3 className="text-lg text-gray-800 mb-4">Get in touch</h3>
          <p className="text-gray-500 mb-4">
            Want to list your handcrafted products on our website & partner with us?
          </p>
          <p className="font-medium text-sm text-gray-500 mb-6">
            Enter your email. Our team will contact you soon.
          </p>
          <form className="flex">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            <li>
              <Link to="/collections/all?category=Jewellery" className="hover:text-gray-500 transition-colors">Jewellery</Link>
            </li>
            <li>
              <Link to="/collections/all?category=Bags" className="hover:text-gray-500 transition-colors">Bags</Link>
            </li>
            <li>
              <Link to="/collections/all?category=T-Shirt" className="hover:text-gray-500 transition-colors">Handwoven T-Shirts</Link>
            </li>
            <li>
              <Link to="/collections/all?category=Sketches" className="hover:text-gray-500 transition-colors">Sketches</Link>
            </li>
          </ul>
        </div>
