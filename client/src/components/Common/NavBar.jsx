    ...
    <>
      <nav className="container mx-auto flex items-center justify-between py-4 px-6 relative">
        ...
        <div className="hidden md:flex space-x-6">
          <Link to="/collections/all?category=Jewellery" className="text-gray-700 hover:text-black text-sm font-medium uppercase">
            Jewellery
          </Link>
          <Link to="/collections/all?category=Bags" className="text-gray-700 hover:text-black text-sm font-medium uppercase">
            Bags
          </Link>
          <Link to="/collections/all?category=T-Shirt" className="text-gray-700 hover:text-black text-sm font-medium uppercase">
            Handwoven T-Shirts
          </Link>
          <Link to="/collections/all?category=Sketches" className="text-gray-700 hover:text-black text-sm font-medium uppercase">
            Sketches
          </Link>
        </div>
